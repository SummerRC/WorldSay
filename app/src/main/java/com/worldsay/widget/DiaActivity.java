...
public class DiaActivity extends Activity implements OnClickListener {
	private Button btn1;
	private Button btn2;
	private Button btn3;
	private Button btn4;
	...
	public void onClick(View v) {
		switch (v.getId()) {
			case R.id.btn1:
				new ActionSheetDialog(DiaActivity.this)
						.builder()
				...
				new ActionSheetDialog(DiaActivity.this)
						...
						.addSheetItem("条目一", ActionSheetDialog.SheetItemColor.Blue,
								new ActionSheetDialog.OnSheetItemClickListener() {
									@Override
									public void onClick(int which) {
										Toast.makeText(DiaActivity.this,
			...
			case R.id.btn4:
				new AlertDialog(DiaActivity.this).builder().setTitle("退出当前账号")
				...
				break;
			case R.id.btn5:
				new AlertDialog(DiaActivity.this).builder()
