...
public class DateUtil {
    ...
    public static String getSessionTime(int mTimeStamp) {
        ...
        String strDesc = null;
        SimpleDateFormat formatYear = new SimpleDateFormat("yy年MM月dd日");
    ...
    public static String getTime(int mTimeStamp) {
        SimpleDateFormat formatYear = new SimpleDateFormat("yyyy-MM-dd HH:mm");
        long changeTime = (long) mTimeStamp;
        long messageTimeStamp = changeTime * 1000;
        String strTimeDesc = formatYear.format(messageTimeStamp);
        return strTimeDesc;
    }
